    ...
    <main className="bg-[#f8f4e8] text-slate-900">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="mt-6 max-w-4xl mx-auto text-lg md:text-xl text-slate-700">
          Em cada criança mora um universo de sonhos, imaginação e alegria. Pensando nisso, nasce o Estação Sorriso, um projeto de arrecadação de brinquedos que também mobiliza nossa comunidade para doar alimentos e agasalhos — transformando generosidade em sorrisos!
        </p>
        ...
        <div className="mt-10 w-full max-w-2xl mx-auto">
          <div className="flex items-center justify-between text-sm font-medium">
            <span>Meta: {meta.goal} itens</span>
      ...
      <section id="o-que-buscamos" className="container mx-auto px-4 py-14">
        ...
        <ul className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            { title: "Alimentos não perecíveis", desc: "Arroz, feijão, macarrão, leite UHT, óleo, enlatados (lacrados e dentro do prazo)." },
            { title: "Agasalhos e cobertores", desc: "Roupas de frio, meias, calçados e cobertores limpos e em bom estado." },
          ].map((item) => (
        ...
        <div className="mt-6 text-center text-sm text-slate-600">
          <span className="inline-flex items-center gap-2">
            ...
            Higienize os itens; alimentos devem estar lacrados e dentro do prazo de validade.
          </span>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-14 bg-white">
        ...
        <ul className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            "Alimentos perecíveis, abertos ou vencidos",
            "Roupas sujas, rasgadas ou com mofo",
      ...
      <section id="como-doar" className="container mx-auto px-4 py-14">
        ...
        <ol className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            { etapa: "1. Entregue", texto: "Leve sua doação (brinquedos, alimentos ou agasalhos) a um ponto de coleta." },
            { etapa: "2. Triagem", texto: "Separação por tipo e faixa etária; conferimos validade dos alimentos." },
            { etapa: "3. Higienização", texto: "Limpeza e verificação de segurança; roupas passam por checagem." },
            { etapa: "4. Entrega", texto: "Distribuição em instituições e famílias parceiras." },
          ].map((s) => (
      ...
      <section id="pontos-de-coleta" className="container mx-auto px-4 py-14 bg-white">
        ...
        <p className="mt-2 text-center text-slate-600">Recebemos brinquedos, alimentos e agasalhos.</p>
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <ul role="list" className="space-y-4">
            {[
              { nome: "Escola IENI", endereco: "Rod. Tertuliano Brito Xavier, 1789 – Canasvieiras", horario: "Seg–Sex, 7:30h–12:30h" },
              { nome: "ELITI Kids", endereco: "Rua José Rosa, Esq, Tv. do Skate – Canasvieiras", horario: "Terças, 18:30h–21h" },
            ].map((p) => (
      ...
      <section className="container mx-auto px-4 py-14">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { numero: "0", legenda: "itens arrecadados desde 2025" },
      ...
      <section id="faq" className="container mx-auto px-4 py-14 bg-white">
        ...
        <div className="mt-8 max-w-3xl mx-auto divide-y divide-slate-200">
          {[
            ...
            { q: "Posso doar alimentos e agasalhos?", a: "Sim. Alimentos devem ser não perecíveis, lacrados e dentro do prazo; agasalhos limpos e em bom estado." },
          ...
          return (
            <>
              <div className="mt-8 mx-auto grid max-w-xl grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                >
                  {/* ícone WhatsApp */}
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.52 3.48A11.91 11.91 0 0012.04 0 12 12 0 000 12a11.9 11.9 0 003.48 8.52A12 12 0 0012 24h.01A12 12 0 0024 12a11.91 11.91 0 00-3.48-8.52z"/></svg>
                  Chamar no WhatsApp
                </a>
              ...
              >
                <svg className="h-7 w-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.52 3.48A11.91 11.91 0 0012.04 0 12 12 0 000 12a11.9 11.9 0 003.48 8.52A12 12 0 0012 24h.01A12 12 0 0024 12a11.91 11.91 0 00-3.48-8.52z"/></svg>
              </a>
            </>
          );
        })()}
